              ...
              <div className="space-y-4 animate-in fade-in duration-300">
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-zinc-600 max-w-xs mx-auto">
                    Consulte tes emails sur <strong className="text-black">{email}</strong> et entre le code à 6 chiffres.
                  </p>
                </div>
                ...
                <form onSubmit={handleVerifyOtp} className="space-y-3 pt-2 text-left">
                  ...
                  >
                    {isVerifyingOtp ? (
                      ...
                      <span>Valider mon code et me connecter</span>
                    )}
                  </button>
                </form>
              ...
              <>
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-zinc-600 max-w-xs mx-auto">
                    Accède directement à tes cours et fiches de révision.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-center gap-1.5 text-xs text-zinc-500 pt-1">
                  ...
                  <span>Accès sécurisé Supabase Magic Link / OTP</span>
                </div>
              </>
            )}
          </div>
