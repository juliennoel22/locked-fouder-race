    ...
    <main className="min-h-[100dvh] w-full bg-white text-black selection:bg-black selection:text-white">
      <div className="w-full max-w-md mx-auto min-h-[100dvh] flex flex-col justify-between p-4 bg-white text-black selection:bg-black selection:text-white">
        ...
        <div className="py-3 flex items-center justify-between gap-2 text-xs border-t border-zinc-100 mt-2">
          <a href="https://founderrace.com/en/" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-1.5 text-zinc-600 hover:text-black transition group opacity-90">
          ...
          <Link href="/recap" className="text-[11px] font-bold text-[#4457f4] hover:underline transition">
            Page Récap Jury →
          </Link>
        </div>
      </div>
